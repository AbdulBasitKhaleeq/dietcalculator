...
if (isset($_POST["saveDiet"]) && isset($_POST["food_array"]) && is_array($_POST["food_array"]) && is_array($_POST["ex_array"])){
    ...
    $ideal_weight = (int) $_POST["idealWeight"];
    $bmr = (int) $_POST["bmr"];
    $maintain_weight_calories = (int) $_POST["reqCal"];
    $initial_daily_calories_burn = (int) $_POST["initialCalNeed"];
    ...
    $sql = "UPDATE plan SET name= '$name', gender = '$gender', age = '$age', weight= '$weight', height= '$height', lifestyle='$lifestyle', autolife ='$autolife', idealWeight= '$ideal_weight', bmr='$bmr', reqCal='$maintain_weight_calories', initialCal='$initial_daily_calories_burn', goalStart='$start_date', goalEnd='$end_date' where planId='$pid'";
    ...
    $sql = "DELETE FROM foodchart where planId = $pid";
    if (mysqli_query($conn, $sql) === True){
    ...
    $sql = "DELETE FROM exchart where planId = $pid";
    if (mysqli_query($conn, $sql) === True){
