...
<div class="container background">
	...
	<br><br>
		...
		<form method="POST" action="updateFormBackend.php" enctype=""  target="_blank" id="calform">
		<div class="container" style="width:70%"><!-- .container-->
			...
			<h2 class="text-center">Enter Basic details</h2>
				...
				<br>
				<div class="row">
					<h2 class="text-center">Plan your own Diet and Exercise chart to match <span id="repetedCalori" class="bg-pink"></span> calories</h2>
	...
	function printDiv() 
{
  ...
  setTimeout(function(){newWin.close();},10);
	...
	<script src="https://weightloss.ohsclub.com/js/update_form_handled.js"></script>
	<script src="https://weightloss.ohsclub.com/js/form_handled.js"></script>
