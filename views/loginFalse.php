...
<body>
	...
	<form method="POST" action="printChart.php" enctype=""  target="_blank"  id="calform">
		...
		<div class="row">
			...
			<br>
			<div class="row">
				<h2 class="text-center">Plan your own Diet and Exercise chart calories to match <span id="repetedCalori"></span> </h2> 
			...
			<div class="foodPlanSection">
                ...
                <div class="row text-center">
					...
					<div class="col-md-4">
					<button type="submit" name="submit" id="downloadChart" class="btn">Download Chart</button>
                        <!-- <button class="btn add_ex_fields">Add Exercise</button> -->
					</div>
					<div class="col-md-4">
	...
	function printDiv() 
{
  ...
  setTimeout(function(){newWin.close();},10);
	...
	<script  src="js/form_handled.js"></script>
